...
Пишу всякое, что мне нужно без раздумий(если вайбкожу, то только для обучения).
...
![Python](https://img.shields.io/badge/-Python-6DB33F?style=flat&logo=python&logoColor=white)
...
![CSS3](https://custom-icon-badges.demolab.com/badge/-CSS-1572B6?style=flat&logo=css3&logoColor=white)
...
Допилить свой калькулятор на ![C](https://img.shields.io/badge/-C-00599C?style=flat&logo=c&logoColor=white)

Допилить свои будущие проекты(SimpleLinkManager, LTNOTES)
